...
- Name: Julian Patterson
  ...
  - source: `src/app/layout.tsx`, site title, and contact footer
- Pronouns: TBD
  - publication: Needs approval
- Preferred headline: Software Engineer · Data Scientist
  - publication: Public
  - source_status: Canonical code
...
- Email: `julian.e.patterson@icloud.com`
  - publication: Public
  - source_status: Canonical code
...
- Do not infer nationality, citizenship, age, pronouns, or work authorization.
- Employer/client facts and metrics require explicit approval or an already-public source.
