...
- Software engineering: TypeScript/JavaScript, React, Next.js, Docker, GitHub Actions
- Data and machine learning: Python, PyTorch/PyTorch Geometric, NLP, forecasting, statistics
