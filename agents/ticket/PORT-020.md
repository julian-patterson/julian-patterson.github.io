# PORT-020 — Refresh the Hero section

- Status: Blocked
- Priority: P1
- Source: owner response to RQ-003 on 2026-07-22
- Depends on: PORT-001, PORT-005
- Required approvals: [RQ-001](../REVIEW-QUESTIONS.md#rq-001), [RQ-002](../REVIEW-QUESTIONS.md#rq-002)
- Owner: unassigned
- Blocker: the current location/status wording and final positioning must be resolved before rewriting the Hero
...
- [ ] Responsive, keyboard, reduced-motion, build, and type checks are recorded.
